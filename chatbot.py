...
def run_chatbot():
    """
    Runs an interactive chatbot loop.
    - If the user's input is a greeting (e.g., "hello", "hi", "hey"), responds with a friendly greeting.
    - Otherwise, sends the question to chatbot_answer to generate a response using the LLaMA model.
    """
    print("Chatbot is ready! Type your research question (or 'exit' to quit):")
    greetings = {"hello", "hi", "hey"}
